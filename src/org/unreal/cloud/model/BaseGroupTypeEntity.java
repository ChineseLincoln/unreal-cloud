...
@javax.persistence.Table(name = "base_group_type", schema = "ag_admin", catalog = "")
public class BaseGroupTypeEntity {
    private int id;
    private String code;
    private String name;
    ...
    public boolean equals(Object object) {
        ...
        BaseGroupTypeEntity that = (BaseGroupTypeEntity) object;
