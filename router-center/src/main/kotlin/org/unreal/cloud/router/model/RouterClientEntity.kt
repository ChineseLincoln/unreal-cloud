...
@Entity
@Table(name = "router_client", schema = "unreal_router")
class RouterClientEntity : Serializable {
    @get:Id
    @get:GeneratedValue
    @get:Column(name = "id")
    var id: Long = 0
    ...
    @get:Basic
    @get:Column(name = "secret")
    var secret: String? = null
    @get:Basic
    @get:Column(name = "name")
    var name: String? = null
    @get:Basic
    @get:Column(name = "locked")
